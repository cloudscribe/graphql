...
* [GraphQL for .NET](https://github.com/graphql-dotnet/graphql-dotnet) (an alternative to traditional REST APIs created by Facebook ([official docs](https://graphql.org/learn/)), ported to .NET by @joemcbride et al.)
